...
app.post('/nomor-surat', (req, res) => {
    ...
    const query = `INSERT INTO ${table1} (jenis_surat, pengirim, tanggal, bulan, tahun, perihal, link) VALUES ('${jenisSurat}', '${pengirim}', ${date.getDate()}, ${date.getMonth()+1}, ${date.getFullYear()}, '${perihal}', '${link}')`
    db.query(query, (error, fields) => {
        if (error) response(res, 'invalid', 'error', 500)
